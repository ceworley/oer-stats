...
Using a significance level $\alpha = `r alpha`$, with the two samples below, determine whether the difference of means is significantly far from 0. To do so, calculate $t^{\star}$ and $t_\text{obs}$. (Please assume $df=\text{min}(n_1,n_2)-1$.)

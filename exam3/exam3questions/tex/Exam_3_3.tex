...
\begin{enumerate}
  ...
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE = 1.73$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.075$}\\
  ...
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE = 4.89$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 3.27$}\\
      \item \exstring{$0.02 < p\text{-value} < 0.04$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.0537 or $5.37\%$}\\
      \item \exstring{UB of p CI = 0.11 or $11\%$} 
  \end{enumerate}
  \item \exstring{$n \approx 850$}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$\mid z_\text{obs} \mid=2.8$}\\
      \item \exstring{$p\text{-value} = 0.0052$}\\
      \item \exstring{reject} 
  \end{enumerate}
\end{enumerate}

...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB = 10.7}\\
      \item \exstring{UB = 16.5} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0: \mu_\text{diff}=0$}\\
      \item \exstring{$H_\text{A}: \mu_\text{diff} \ne 0$}\\
      \item \exstring{$t^\star = 2.61$}\\
      \item \exstring{$SE = 0.96$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.708$}\\
  ...
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$t^\star = 3.25$}\\
      \item \exstring{$SE = 0.685$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 3.17$}\\
      \item \exstring{$0.01 < p\text{-value} < 0.02$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.733 or $73.3\%$}\\
      \item \exstring{UB of p CI = 0.745 or $74.5\%$} 
  \end{enumerate}
  \item \exstring{$n \approx 4200$}
  \item 
   \begin{enumerate}

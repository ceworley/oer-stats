...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB = 68.2}\\
      \item \exstring{UB = 78.3} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE = 1.42$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 1.831$}\\
      \item \exstring{$0.1 < p\text{-value} < 1$}\\
  ...
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.326 or $32.6\%$}\\
      \item \exstring{UB of p CI = 0.34 or $34\%$} 
  \end{enumerate}
  \item \exstring{$n \approx 42000$}
  \item 
   \begin{enumerate}

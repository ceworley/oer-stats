...
As an ornithologist, you wish to determine the average body mass of *`r name`*. You randomly capture `r n` adults of *`r name`*, resulting in a sample mean of `r xbar` grams and a sample standard deviation of `r s` grams. You decide to report a `r cl*100`% confidence interval. 

Answerlist
--------
* Determine the lower bound of the confidence interval.
* Determine the upper bound of the confidence interval.

...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{horn or red})$ $=0.449$}\\
      \item \exstring{$P(\text{horn})$ $=0.242$}\\
      \item \exstring{$P(\text{wheel and red})$ $=0.0746$}\\
      \item \exstring{$P(\text{orange})$ $=0.357$}\\
      \item \exstring{$P(\text{shovel given orange})$ $=0.0514$}\\
      \item \exstring{$P(\text{teal given dog})$ $=0.453$} 
  \end{enumerate}
  \item \exstring{$P(\text{"tree" given "green"}) = 0.0532 $}
  \item \exstring{$P(61.96 < X < 62.41) = 0.6884 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=32) = 0.1093$ }\\
      \item \exstring{ $P(29\le X \le 35) = 0.6159$} 
  \end{enumerate}
  \item \exstring{(11.5,\,12.6)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.13$}\\
      \item \exstring{$SE = 0.049$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 1.83$}\\
      \item \exstring{$0.05 < p\text{-value} < 0.1$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.496 or $49.6\%$}\\
  ...
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.141$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.75$}\\
      \item \exstring{$p\text{-value} = 0.006$}\\
      \item \exstring{retain} 
  \end{enumerate}
\end{enumerate}

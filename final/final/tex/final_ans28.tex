...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{gem and blue})$ $=0.0854$}\\
      \item \exstring{$P(\text{orange given dog})$ $=0.114$}\\
      \item \exstring{$P(\text{dog})$ $=0.183$}\\
      \item \exstring{$P(\text{yellow})$ $=0.154$}\\
      \item \exstring{$P(\text{gem given red})$ $=0.366$}\\
      \item \exstring{$P(\text{flower or orange})$ $=0.316$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not shovel" given "pink"}) = 0.75 $}
  \item \exstring{$P(64.77 < X < 65.05) = 0.728 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=53) = 0.0613$ }\\
      \item \exstring{ $P(45\le X \le 66) = 0.8542$} 
  \end{enumerate}
  \item \exstring{(15.4,\,17)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.65$}\\
      \item \exstring{$SE = 0.426$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.54$}\\
      \item \exstring{$0.01 < p\text{-value} < 0.02$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.27 or $27\%$}\\
      \item \exstring{UB of p CI = 0.284 or $28.4\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$\mid z_\text{obs} \mid=1.36$}\\
      \item \exstring{$p\text{-value} = 0.1738$}\\

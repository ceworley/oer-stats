...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{pig given black})$ $=0.117$}\\
      \item \exstring{$P(\text{pig and green})$ $=0.0868$}\\
      \item \exstring{$P(\text{green})$ $=0.299$}\\
      \item \exstring{$P(\text{horn or green})$ $=0.483$}\\
      \item \exstring{$P(\text{green given bike})$ $=0.156$}\\
      \item \exstring{$P(\text{wheel})$ $=0.166$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not shovel" given "not yellow"}) = 0.577 $}
  \item \exstring{$P(60.8 < X < 61.26) = 0.7409 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=18) = 0.0924$ }\\
      \item \exstring{ $P(22\le X \le 29) = 0.2799$} 
  \end{enumerate}
  \item \exstring{(13.8,\,16)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.46$}\\
      \item \exstring{$SE = 0.756$}\\
  ...
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.274 or $27.4\%$}\\
      \item \exstring{UB of p CI = 0.31 or $31\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}

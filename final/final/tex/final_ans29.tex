...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{bike or yellow})$ $=0.376$}\\
      \item \exstring{$P(\text{blue})$ $=0.21$}\\
      \item \exstring{$P(\text{pig})$ $=0.201$}\\
      \item \exstring{$P(\text{wheel and blue})$ $=0.0604$}\\
      \item \exstring{$P(\text{teal given gem})$ $=0.599$}\\
      \item \exstring{$P(\text{wheel given blue})$ $=0.288$} 
  \end{enumerate}
  \item \exstring{$P(\text{"kite" given "green"}) = 0.0572 $}
  \item \exstring{$P(61.1 < X < 61.83) = 0.7739 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=30) = 0.0558$ }\\
      \item \exstring{ $P(24\le X \le 41) = 0.9097$} 
  \end{enumerate}
  \item \exstring{(29.6,\,41)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.4$}\\
      \item \exstring{$SE = 0.062$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.1$}\\
      \item \exstring{$0.04 < p\text{-value} < 0.05$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.138 or $13.8\%$}\\
      \item \exstring{UB of p CI = 0.252 or $25.2\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.09$}\\
      \item \exstring{$\mid z_\text{obs} \mid=1.92$}\\
      \item \exstring{$p\text{-value} = 0.0548$}\\

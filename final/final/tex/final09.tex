...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{gray given tree})$ $=0.369$}\\
      \item \exstring{$P(\text{pink})$ $=0.406$}\\
      \item \exstring{$P(\text{bike})$ $=0.234$}\\
      \item \exstring{$P(\text{wheel or yellow})$ $=0.363$}\\
      \item \exstring{$P(\text{flower and gray})$ $=0.0612$}\\
      \item \exstring{$P(\text{wheel given pink})$ $=0.275$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not bike" given "red"}) = 0.754 $}
  \item \exstring{$P(72.72 < X < 73.31) = 0.7656 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=37) = 0.0449$ }\\
      \item \exstring{ $P(31\le X \le 42) = 0.5809$} 
  \end{enumerate}
  \item \exstring{(59.1,\,76.7)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.09$}\\
      \item \exstring{$SE = 0.576$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.34$}\\
      \item \exstring{$0.02 < p\text{-value} < 0.04$}\\
      \item \exstring{reject} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.618 or $61.8\%$}\\
      \item \exstring{UB of p CI = 0.656 or $65.6\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.048$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.59$}\\
      \item \exstring{$p\text{-value} = 0.0096$}\\
      \item \exstring{reject} 
  \end{enumerate}
\end{enumerate}

...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{flower or indigo})$ $=0.44$}\\
      \item \exstring{$P(\text{indigo given flower})$ $=0.278$}\\
      \item \exstring{$P(\text{flower})$ $=0.303$}\\
      \item \exstring{$P(\text{flower and gray})$ $=0.0266$}\\
      \item \exstring{$P(\text{pig given green})$ $=0.165$}\\
      \item \exstring{$P(\text{green})$ $=0.147$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not horn" given "pink"}) = 0.83 $}
  \item \exstring{$P(62.06 < X < 62.47) = 0.8183 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=68) = 0.0508$ }\\
      \item \exstring{ $P(61\le X \le 82) = 0.8702$} 
  \end{enumerate}
  \item \exstring{(9.44,\,10.4)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.74$}\\
      \item \exstring{$SE = 0.054$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.84$}\\
      \item \exstring{$0.005 < p\text{-value} < 0.01$}\\
      \item \exstring{reject} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.677 or $67.7\%$}\\
      \item \exstring{UB of p CI = 0.699 or $69.9\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.083$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.47$}\\
      \item \exstring{$p\text{-value} = 0.0136$}\\
      \item \exstring{reject} 
  \end{enumerate}
\end{enumerate}

...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{black given flower})$ $=0.273$}\\
      \item \exstring{$P(\text{blue})$ $=0.15$}\\
      \item \exstring{$P(\text{bike and teal})$ $=0.0735$}\\
      \item \exstring{$P(\text{bike or gray})$ $=0.504$}\\
      \item \exstring{$P(\text{bike given teal})$ $=0.399$}\\
      \item \exstring{$P(\text{wheel})$ $=0.35$} 
  \end{enumerate}
  \item \exstring{$P(\text{"pig" given "yellow"}) = 0.246 $}
  \item \exstring{$P(70.9 < X < 71.15) = 0.8892 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=132) = 0.0604$ }\\
      \item \exstring{ $P(120\le X \le 126) = 0.1968$} 
  \end{enumerate}
  \item \exstring{(17.7,\,19.8)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.49$}\\
      \item \exstring{$SE = 0.565$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.37$}\\
      \item \exstring{$0.02 < p\text{-value} < 0.04$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.565 or $56.5\%$}\\
      \item \exstring{UB of p CI = 0.579 or $57.9\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.039$}\\
      \item \exstring{$\mid z_\text{obs} \mid=1.37$}\\
      \item \exstring{$p\text{-value} = 0.1706$}\\

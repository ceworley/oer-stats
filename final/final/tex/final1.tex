...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{wheel given red})$ $=0.61$}\\
      \item \exstring{$P(\text{wheel or gray})$ $=0.499$}\\
      \item \exstring{$P(\text{violet given wheel})$ $=0.103$}\\
      \item \exstring{$P(\text{orange})$ $=0.217$}\\
      \item \exstring{$P(\text{cat})$ $=0.296$}\\
      \item \exstring{$P(\text{cat and orange})$ $=0.0628$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not kite" given "gray"}) = 0.881 $}
  \item \exstring{$P(68.39 < X < 68.91) = 0.7856 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=19) = 0.1032$ }\\
      \item \exstring{ $P(13\le X \le 25) = 0.8758$} 
  \end{enumerate}
  \item \exstring{(17.1,\,20.4)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.72$}\\
      \item \exstring{$SE = 8.005$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.5$}\\
      \item \exstring{$0.01 < p\text{-value} < 0.02$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.709 or $70.9\%$}\\
      \item \exstring{UB of p CI = 0.763 or $76.3\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.029$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.76$}\\
      \item \exstring{$p\text{-value} = 0.0058$}\\

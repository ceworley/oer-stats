...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{green given wheel})$ $=0.341$}\\
      \item \exstring{$P(\text{wheel or pink})$ $=0.431$}\\
      \item \exstring{$P(\text{bike})$ $=0.304$}\\
      \item \exstring{$P(\text{wheel and gray})$ $=0.0169$}\\
      \item \exstring{$P(\text{indigo})$ $=0.18$}\\
      \item \exstring{$P(\text{shovel given pink})$ $=0.27$} 
  \end{enumerate}
  \item \exstring{$P(\text{"kite" given "not indigo"}) = 0.45 $}
  \item \exstring{$P(71.51 < X < 71.95) = 0.5183 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=83) = 0.0583$ }\\
      \item \exstring{ $P(70\le X \le 77) = 0.0986$} 
  \end{enumerate}
  \item \exstring{(64.3,\,75.1)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.2$}\\
      \item \exstring{$SE = 28.699$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.09$}\\
      \item \exstring{$0.05 < p\text{-value} < 0.1$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.671 or $67.1\%$}\\
      \item \exstring{UB of p CI = 0.705 or $70.5\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.028$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.61$}\\
      \item \exstring{$p\text{-value} = 0.009$}\\

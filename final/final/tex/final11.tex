...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{gray given bike})$ $=0.145$}\\
      \item \exstring{$P(\text{shovel given red})$ $=0.388$}\\
      \item \exstring{$P(\text{bike})$ $=0.316$}\\
      \item \exstring{$P(\text{cat and red})$ $=0.0218$}\\
      \item \exstring{$P(\text{white})$ $=0.14$}\\
      \item \exstring{$P(\text{bike or red})$ $=0.413$} 
  \end{enumerate}
  \item \exstring{$P(\text{"shovel" given "not yellow"}) = 0.355 $}
  \item \exstring{$P(61.3 < X < 61.93) = 0.7783 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=140) = 0.0441$ }\\
      \item \exstring{ $P(127\le X \le 149) = 0.884$} 
  \end{enumerate}
  \item \exstring{(14.6,\,16.9)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.39$}\\
      \item \exstring{$SE = 0.052$}\\
  ...
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.278 or $27.8\%$}\\
      \item \exstring{UB of p CI = 0.304 or $30.4\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.041$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.1$}\\
      \item \exstring{$p\text{-value} = 0.0358$}\\

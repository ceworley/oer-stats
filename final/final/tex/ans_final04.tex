...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{flower})$ $=0.382$}\\
      \item \exstring{$P(\text{gem and red})$ $=0.108$}\\
      \item \exstring{$P(\text{flower or red})$ $=0.557$}\\
      \item \exstring{$P(\text{violet given bike})$ $=0.12$}\\
      \item \exstring{$P(\text{bike given violet})$ $=0.167$}\\
      \item \exstring{$P(\text{indigo})$ $=0.251$} 
  \end{enumerate}
  \item \exstring{$P(\text{"gem" given "not green"}) = 0.41 $}
  \item \exstring{$P(70.3 < X < 70.48) = 0.5709 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=21) = 0.0893$ }\\
      \item \exstring{ $P(12\le X \le 29) = 0.9456$} 
  \end{enumerate}
  \item \exstring{(22,\,22.9)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.1$}\\
      \item \exstring{$SE = 6.868$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.18$}\\
      \item \exstring{$0.02 < p\text{-value} < 0.04$}\\
      \item \exstring{reject} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.849 or $84.9\%$}\\
      \item \exstring{UB of p CI = 0.885 or $88.5\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.072$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.22$}\\
      \item \exstring{$p\text{-value} = 0.0264$}\\
      \item \exstring{reject} 
  \end{enumerate}
\end{enumerate}

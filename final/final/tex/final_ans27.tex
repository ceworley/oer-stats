...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{flower})$ $=0.318$}\\
      \item \exstring{$P(\text{teal given shovel})$ $=0.329$}\\
      \item \exstring{$P(\text{teal})$ $=0.373$}\\
      \item \exstring{$P(\text{dog or red})$ $=0.408$}\\
      \item \exstring{$P(\text{shovel given red})$ $=0.517$}\\
      \item \exstring{$P(\text{shovel and teal})$ $=0.147$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not kite" given "orange"}) = 0.577 $}
  \item \exstring{$P(67.5 < X < 67.67) = 0.7121 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=73) = 0.0704$ }\\
      \item \exstring{ $P(73\le X \le 81) = 0.2949$} 
  \end{enumerate}
  \item \exstring{(14.3,\,17.7)}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$\mid t_\text{obs}\mid = 2.08$}\\
      \item \exstring{$0.04 < p\text{-value} < 0.05$}\\
      \item \exstring{reject} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.629 or $62.9\%$}\\
      \item \exstring{UB of p CI = 0.653 or $65.3\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}

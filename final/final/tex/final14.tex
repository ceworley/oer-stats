...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{cat and indigo})$ $=0.0818$}\\
      \item \exstring{$P(\text{black})$ $=0.347$}\\
      \item \exstring{$P(\text{pig or indigo})$ $=0.471$}\\
      \item \exstring{$P(\text{pig given indigo})$ $=0.373$}\\
      \item \exstring{$P(\text{pig})$ $=0.244$}\\
      \item \exstring{$P(\text{black given flower})$ $=0.65$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not shovel" given "violet"}) = 0.247 $}
  \item \exstring{$P(72.76 < X < 73.89) = 0.8933 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=26) = 0.1302$ }\\
      \item \exstring{ $P(21\le X \le 26) = 0.5714$} 
  \end{enumerate}
  \item \exstring{(14.5,\,16.3)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.67$}\\
      \item \exstring{$SE = 0.682$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.81$}\\
      \item \exstring{$0.005 < p\text{-value} < 0.01$}\\
      \item \exstring{reject} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.931 or $93.1\%$}\\
      \item \exstring{UB of p CI = 0.949 or $94.9\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.044$}\\
      \item \exstring{$\mid z_\text{obs} \mid=1.55$}\\
      \item \exstring{$p\text{-value} = 0.1212$}\\
      \item \exstring{reject} 
  \end{enumerate}
\end{enumerate}

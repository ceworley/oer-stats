...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{horn given black})$ $=0.4$}\\
      \item \exstring{$P(\text{pig or teal})$ $=0.614$}\\
      \item \exstring{$P(\text{teal given pig})$ $=0.358$}\\
      \item \exstring{$P(\text{horn and indigo})$ $=0.0707$}\\
      \item \exstring{$P(\text{black})$ $=0.269$}\\
      \item \exstring{$P(\text{pig})$ $=0.367$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not horn" given "black"}) = 0.821 $}
  \item \exstring{$P(71.36 < X < 71.65) = 0.493 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=41) = 0.0718$ }\\
      \item \exstring{ $P(33\le X \le 51) = 0.8808$} 
  \end{enumerate}
  \item \exstring{(41.3,\,43.5)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.45$}\\
      \item \exstring{$SE = 4.179$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.39$}\\
      \item \exstring{$0.02 < p\text{-value} < 0.04$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.0569 or $5.69\%$}\\
      \item \exstring{UB of p CI = 0.0731 or $7.31\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.056$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.31$}\\
      \item \exstring{$p\text{-value} = 0.0208$}\\

...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{indigo given gem})$ $=0.414$}\\
      \item \exstring{$P(\text{bike or teal})$ $=0.574$}\\
      \item \exstring{$P(\text{shovel given red})$ $=0.176$}\\
      \item \exstring{$P(\text{shovel})$ $=0.167$}\\
      \item \exstring{$P(\text{indigo})$ $=0.312$}\\
      \item \exstring{$P(\text{dog and indigo})$ $=0.0713$} 
  \end{enumerate}
  \item \exstring{$P(\text{"flower" given "white"}) = 0.175 $}
  \item \exstring{$P(72.57 < X < 72.81) = 0.6332 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=82) = 0.0498$ }\\
      \item \exstring{ $P(65\le X \le 78) = 0.5509$} 
  \end{enumerate}
  \item \exstring{(18.6,\,20.8)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.12$}\\
      \item \exstring{$SE = 0.531$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.26$}\\
      \item \exstring{$0.02 < p\text{-value} < 0.04$}\\
      \item \exstring{reject} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.947 or $94.7\%$}\\
      \item \exstring{UB of p CI = 0.957 or $95.7\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.167$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.67$}\\
      \item \exstring{$p\text{-value} = 0.0076$}\\

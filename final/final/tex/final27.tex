...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{indigo given gem})$ $=0.206$}\\
      \item \exstring{$P(\text{gem given blue})$ $=0.092$}\\
      \item \exstring{$P(\text{tree and blue})$ $=0.125$}\\
      \item \exstring{$P(\text{green})$ $=0.348$}\\
      \item \exstring{$P(\text{flower or indigo})$ $=0.397$}\\
      \item \exstring{$P(\text{gem})$ $=0.25$} 
  \end{enumerate}
  \item \exstring{$P(\text{"flower" given "teal"}) = 0.404 $}
  \item \exstring{$P(73.15 < X < 74.28) = 0.8683 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=10) = 0.0987$ }\\
      \item \exstring{ $P(12\le X \le 21) = 0.6114$} 
  \end{enumerate}
  \item \exstring{(12.6,\,13.2)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.8$}\\
      \item \exstring{$SE = 53.33$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.66$}\\
      \item \exstring{$0.01 < p\text{-value} < 0.02$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.291 or $29.1\%$}\\
      \item \exstring{UB of p CI = 0.301 or $30.1\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.046$}\\
      \item \exstring{$\mid z_\text{obs} \mid=1.83$}\\
      \item \exstring{$p\text{-value} = 0.0672$}\\

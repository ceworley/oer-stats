...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{blue})$ $=0.389$}\\
      \item \exstring{$P(\text{red given gem})$ $=0.294$}\\
      \item \exstring{$P(\text{wheel and red})$ $=0.0574$}\\
      \item \exstring{$P(\text{gem or blue})$ $=0.531$}\\
      \item \exstring{$P(\text{gem given red})$ $=0.234$}\\
      \item \exstring{$P(\text{cat})$ $=0.193$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not cat" given "violet"}) = 0.433 $}
  \item \exstring{$P(60.84 < X < 61.37) = 0.8953 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=49) = 0.0444$ }\\
      \item \exstring{ $P(46\le X \le 54) = 0.3119$} 
  \end{enumerate}
  \item \exstring{(8.95,\,11.1)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.7$}\\
      \item \exstring{$SE = 48.57$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.49$}\\
      \item \exstring{$0.01 < p\text{-value} < 0.02$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.429 or $42.9\%$}\\
      \item \exstring{UB of p CI = 0.451 or $45.1\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$\mid z_\text{obs} \mid=2.14$}\\
      \item \exstring{$p\text{-value} = 0.0324$}\\

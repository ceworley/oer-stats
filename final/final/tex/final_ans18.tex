...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{tree given white})$ $=0.129$}\\
      \item \exstring{$P(\text{white})$ $=0.26$}\\
      \item \exstring{$P(\text{white given tree})$ $=0.157$}\\
      \item \exstring{$P(\text{shovel or teal})$ $=0.487$}\\
      \item \exstring{$P(\text{tree})$ $=0.213$}\\
      \item \exstring{$P(\text{tree and white})$ $=0.0334$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not cat" given "teal"}) = 0.73 $}
  \item \exstring{$P(74 < X < 74.7) = 0.7567 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=28) = 0.0905$ }\\
      \item \exstring{ $P(21\le X \le 32) = 0.7656$} 
  \end{enumerate}
  \item \exstring{(11.7,\,12.3)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.62$}\\
      \item \exstring{$SE = 8.061$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.79$}\\
      \item \exstring{$0.01 < p\text{-value} < 0.02$}\\
      \item \exstring{reject} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.917 or $91.7\%$}\\
      \item \exstring{UB of p CI = 0.921 or $92.1\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}

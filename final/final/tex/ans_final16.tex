...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{bike given black})$ $=0.269$}\\
      \item \exstring{$P(\text{bike and white})$ $=0.0607$}\\
      \item \exstring{$P(\text{shovel or violet})$ $=0.458$}\\
      \item \exstring{$P(\text{wheel})$ $=0.206$}\\
      \item \exstring{$P(\text{white given bike})$ $=0.203$}\\
      \item \exstring{$P(\text{white})$ $=0.273$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not shovel" given "not pink"}) = 0.832 $}
  \item \exstring{$P(59.97 < X < 60.24) = 0.6641 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=107) = 0.0989$ }\\
      \item \exstring{ $P(106\le X \le 115) = 0.7905$} 
  \end{enumerate}
  \item \exstring{(13.9,\,17.4)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.09$}\\
      \item \exstring{$SE = 61.029$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 1.95$}\\
      \item \exstring{$0.05 < p\text{-value} < 0.1$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.165 or $16.5\%$}\\
      \item \exstring{UB of p CI = 0.183 or $18.3\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}

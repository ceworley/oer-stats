...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{gray})$ $=0.277$}\\
      \item \exstring{$P(\text{flower})$ $=0.314$}\\
      \item \exstring{$P(\text{cat and yellow})$ $=0.0432$}\\
      \item \exstring{$P(\text{shovel given pink})$ $=0.152$}\\
      \item \exstring{$P(\text{green given pig})$ $=0.47$}\\
      \item \exstring{$P(\text{pig or yellow})$ $=0.345$} 
  \end{enumerate}
  \item \exstring{$P(\text{"pig" given "not teal"}) = 0.101 $}
  \item \exstring{$P(69.26 < X < 70.28) = 0.8288 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=55) = 0.0437$ }\\
      \item \exstring{ $P(49\le X \le 66) = 0.7827$} 
  \end{enumerate}
  \item \exstring{(19.3,\,22)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.68$}\\
      \item \exstring{$SE = 0.058$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.76$}\\
      \item \exstring{$0.005 < p\text{-value} < 0.01$}\\
      \item \exstring{reject} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.257 or $25.7\%$}\\
      \item \exstring{UB of p CI = 0.271 or $27.1\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}

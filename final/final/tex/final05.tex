...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{wheel given pink})$ $=0.111$}\\
      \item \exstring{$P(\text{pig and pink})$ $=0.0538$}\\
      \item \exstring{$P(\text{pink})$ $=0.262$}\\
      \item \exstring{$P(\text{teal given pig})$ $=0.604$}\\
      \item \exstring{$P(\text{dog or white})$ $=0.4$}\\
      \item \exstring{$P(\text{dog})$ $=0.183$} 
  \end{enumerate}
  \item \exstring{$P(\text{"kite" given "gray"}) = 0.241 $}
  \item \exstring{$P(64.09 < X < 65.2) = 0.7415 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=10) = 0.1432$ }\\
      \item \exstring{ $P(5\le X \le 10) = 0.5167$} 
  \end{enumerate}
  \item \exstring{(8.61,\,9.89)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 1.75$}\\
      \item \exstring{$SE = 13.471$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 1.63$}\\
      \item \exstring{$0.1 < p\text{-value} < 0.2$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.508 or $50.8\%$}\\
      \item \exstring{UB of p CI = 0.516 or $51.6\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0: ~~p_2-p_1=0$}\\
      \item \exstring{$H_\text{A}:~~ p_2-p_1\ne 0$}\\
      \item \exstring{$z^\star = 2.58$}\\
      \item \exstring{$SE=0.044$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.74$}\\
      \item \exstring{$p\text{-value} = 0.0062$}\\

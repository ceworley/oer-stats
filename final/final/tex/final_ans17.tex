...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{dog given white})$ $=0.211$}\\
      \item \exstring{$P(\text{pig and violet})$ $=0.0423$}\\
      \item \exstring{$P(\text{violet given wheel})$ $=0.208$}\\
      \item \exstring{$P(\text{white})$ $=0.341$}\\
      \item \exstring{$P(\text{dog or white})$ $=0.528$}\\
      \item \exstring{$P(\text{wheel})$ $=0.289$} 
  \end{enumerate}
  \item \exstring{$P(\text{"llama" given "not white"}) = 0.0695 $}
  \item \exstring{$P(62.52 < X < 63.24) = 0.8035 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=18) = 0.094$ }\\
      \item \exstring{ $P(14\le X \le 27) = 0.897$} 
  \end{enumerate}
  \item \exstring{(9.58,\,10.8)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 1.69$}\\
      \item \exstring{$SE = 2.667$}\\
  ...
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.449 or $44.9\%$}\\
      \item \exstring{UB of p CI = 0.535 or $53.5\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.063$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.71$}\\
      \item \exstring{$p\text{-value} = 0.0068$}\\
      \item \exstring{reject} 
  \end{enumerate}
\end{enumerate}

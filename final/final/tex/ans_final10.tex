...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{wheel and violet})$ $=0.0324$}\\
      \item \exstring{$P(\text{violet})$ $=0.185$}\\
      \item \exstring{$P(\text{tree or black})$ $=0.314$}\\
      \item \exstring{$P(\text{horn given pink})$ $=0.249$}\\
      \item \exstring{$P(\text{pink given tree})$ $=0.137$}\\
      \item \exstring{$P(\text{flower})$ $=0.203$} 
  \end{enumerate}
  \item \exstring{$P(\text{"horn" given "teal"}) = 0.144 $}
  \item \exstring{$P(66.88 < X < 67.91) = 0.895 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=103) = 0.0616$ }\\
      \item \exstring{ $P(87\le X \le 105) = 0.7548$} 
  \end{enumerate}
  \item \exstring{(37.5,\,40.9)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 1.69$}\\
      \item \exstring{$SE = 31.782$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 1.89$}\\
      \item \exstring{$0.05 < p\text{-value} < 0.1$}\\
      \item \exstring{reject} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.437 or $43.7\%$}\\
      \item \exstring{UB of p CI = 0.455 or $45.5\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$\mid z_\text{obs} \mid=1.81$}\\
      \item \exstring{$p\text{-value} = 0.0702$}\\
      \item \exstring{reject} 
  \end{enumerate}
\end{enumerate}

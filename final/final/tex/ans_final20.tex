...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{cat})$ $=0.202$}\\
      \item \exstring{$P(\text{cat or yellow})$ $=0.351$}\\
      \item \exstring{$P(\text{red})$ $=0.286$}\\
      \item \exstring{$P(\text{pig and yellow})$ $=0.0179$}\\
      \item \exstring{$P(\text{pig given teal})$ $=0.108$}\\
      \item \exstring{$P(\text{indigo given pig})$ $=0.337$} 
  \end{enumerate}
  \item \exstring{$P(\text{"tree" given "not indigo"}) = 0.104 $}
  \item \exstring{$P(66.65 < X < 66.98) = 0.7677 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=39) = 0.0852$ }\\
      \item \exstring{ $P(30\le X \le 45) = 0.904$} 
  \end{enumerate}
  \item \exstring{(9.33,\,10.9)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 1.73$}\\
      \item \exstring{$SE = 7.13$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 1.99$}\\
      \item \exstring{$0.05 < p\text{-value} < 0.1$}\\
      \item \exstring{reject} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.418 or $41.8\%$}\\
      \item \exstring{UB of p CI = 0.458 or $45.8\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}

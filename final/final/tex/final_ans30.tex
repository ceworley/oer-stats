...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{green given wheel})$ $=0.179$}\\
      \item \exstring{$P(\text{flower or teal})$ $=0.43$}\\
      \item \exstring{$P(\text{pink})$ $=0.23$}\\
      \item \exstring{$P(\text{tree})$ $=0.289$}\\
      \item \exstring{$P(\text{shovel given pink})$ $=0.351$}\\
      \item \exstring{$P(\text{tree and yellow})$ $=0.091$} 
  \end{enumerate}
  \item \exstring{$P(\text{"tree" given "not pink"}) = 0.427 $}
  \item \exstring{$P(74.6 < X < 75) = 0.8912 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=44) = 0.0581$ }\\
      \item \exstring{ $P(33\le X \le 38) = 0.2492$} 
  \end{enumerate}
  \item \exstring{(13.8,\,15.9)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.45$}\\
      \item \exstring{$SE = 56.41$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.73$}\\
      \item \exstring{$0.01 < p\text{-value} < 0.02$}\\
      \item \exstring{reject} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.624 or $62.4\%$}\\

...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{flower or white})$ $=0.426$}\\
      \item \exstring{$P(\text{pink given bike})$ $=0.109$}\\
      \item \exstring{$P(\text{orange})$ $=0.218$}\\
      \item \exstring{$P(\text{wheel and blue})$ $=0.0372$}\\
      \item \exstring{$P(\text{bike given blue})$ $=0.128$}\\
      \item \exstring{$P(\text{cat})$ $=0.32$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not llama" given "yellow"}) = 0.886 $}
  \item \exstring{$P(60.5 < X < 60.79) = 0.8051 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=140) = 0.0519$ }\\
      \item \exstring{ $P(144\le X \le 150) = 0.307$} 
  \end{enumerate}
  \item \exstring{(9.36,\,11.3)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 1.69$}\\
      \item \exstring{$SE = 8.867$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 1.76$}\\
      \item \exstring{$0.05 < p\text{-value} < 0.1$}\\
      \item \exstring{reject} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.0974 or $9.74\%$}\\
      \item \exstring{UB of p CI = 0.113 or $11.3\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.068$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.21$}\\
      \item \exstring{$p\text{-value} = 0.0272$}\\
      \item \exstring{reject} 
  \end{enumerate}
\end{enumerate}

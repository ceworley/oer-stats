...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{shovel})$ $=0.247$}\\
      \item \exstring{$P(\text{gray given bike})$ $=0.311$}\\
      \item \exstring{$P(\text{gem and orange})$ $=0.0291$}\\
      \item \exstring{$P(\text{bike given yellow})$ $=0.239$}\\
      \item \exstring{$P(\text{gem or violet})$ $=0.444$}\\
      \item \exstring{$P(\text{violet})$ $=0.258$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not shovel" given "not blue"}) = 0.777 $}
  \item \exstring{$P(69.04 < X < 69.24) = 0.6538 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=59) = 0.0411$ }\\
      \item \exstring{ $P(70\le X \le 76) = 0.1751$} 
  \end{enumerate}
  \item \exstring{(12.5,\,13.2)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 1.72$}\\
      \item \exstring{$SE = 0.489$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 1.43$}\\
      \item \exstring{$0.1 < p\text{-value} < 0.2$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.715 or $71.5\%$}\\
      \item \exstring{UB of p CI = 0.743 or $74.3\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0: ~~p_2-p_1=0$}\\
      \item \exstring{$H_\text{A}:~~ p_2-p_1\ne 0$}\\
      \item \exstring{$z^\star = 1.28$}\\
      \item \exstring{$SE=0.038$}\\
      \item \exstring{$\mid z_\text{obs} \mid=1.39$}\\
      \item \exstring{$p\text{-value} = 0.1646$}\\

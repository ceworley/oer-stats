...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{gray})$ $=0.266$}\\
      \item \exstring{$P(\text{horn and gray})$ $=0.0653$}\\
      \item \exstring{$P(\text{bike})$ $=0.163$}\\
      \item \exstring{$P(\text{wheel given teal})$ $=0.282$}\\
      \item \exstring{$P(\text{gray given horn})$ $=0.384$}\\
      \item \exstring{$P(\text{bike or teal})$ $=0.413$} 
  \end{enumerate}
  \item \exstring{$P(\text{"bike" given "not pink"}) = 0.439 $}
  \item \exstring{$P(71.77 < X < 72.25) = 0.6471 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=74) = 0.0691$ }\\
      \item \exstring{ $P(72\le X \le 83) = 0.6985$} 
  \end{enumerate}
  \item \exstring{(37.4,\,39.4)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.78$}\\
  ...
  \item 
   \begin{enumerate}
      ...
      \item \exstring{UB of p CI = 0.214 or $21.4\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$\mid z_\text{obs} \mid=2.58$}\\
      \item \exstring{$p\text{-value} = 0.0098$}\\

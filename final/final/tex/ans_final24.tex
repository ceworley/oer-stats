...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{indigo})$ $=0.388$}\\
      \item \exstring{$P(\text{tree and white})$ $=0.0438$}\\
      \item \exstring{$P(\text{tree})$ $=0.133$}\\
      \item \exstring{$P(\text{indigo given bike})$ $=0.229$}\\
      \item \exstring{$P(\text{flower or black})$ $=0.444$}\\
      \item \exstring{$P(\text{flower given white})$ $=0.113$} 
  \end{enumerate}
  \item \exstring{$P(\text{"horn" given "gray"}) = 0.823 $}
  \item \exstring{$P(64.9 < X < 66.04) = 0.8844 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=102) = 0.0613$ }\\
      \item \exstring{ $P(92\le X \le 102) = 0.4051$} 
  \end{enumerate}
  \item \exstring{(9.95,\,11)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.14$}\\
      \item \exstring{$SE = 0.027$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 1.88$}\\
      \item \exstring{$0.05 < p\text{-value} < 0.1$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.95 or $95\%$}\\
      \item \exstring{UB of p CI = 0.954 or $95.4\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.07$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.73$}\\
      \item \exstring{$p\text{-value} = 0.0064$}\\
      \item \exstring{retain} 
  \end{enumerate}
\end{enumerate}

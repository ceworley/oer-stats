...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{yellow given gem})$ $=0.209$}\\
      \item \exstring{$P(\text{dog and red})$ $=0.0757$}\\
      \item \exstring{$P(\text{orange})$ $=0.297$}\\
      \item \exstring{$P(\text{dog or red})$ $=0.487$}\\
      \item \exstring{$P(\text{dog given orange})$ $=0.396$}\\
      \item \exstring{$P(\text{gem})$ $=0.383$} 
  \end{enumerate}
  \item \exstring{$P(\text{"cat" given "red"}) = 0.708 $}
  \item \exstring{$P(72.13 < X < 72.47) = 0.8444 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=12) = 0.083$ }\\
      \item \exstring{ $P(7\le X \le 24) = 0.9775$} 
  \end{enumerate}
  \item \exstring{(12.7,\,14.8)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 1.72$}\\
      \item \exstring{$SE = 3.284$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 1.52$}\\
      \item \exstring{$0.1 < p\text{-value} < 0.2$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.31 or $31\%$}\\
      \item \exstring{UB of p CI = 0.318 or $31.8\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.058$}\\
      \item \exstring{$\mid z_\text{obs} \mid=1.54$}\\
      \item \exstring{$p\text{-value} = 0.1236$}\\

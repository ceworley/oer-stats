...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{tree given orange})$ $=0.163$}\\
      \item \exstring{$P(\text{wheel and gray})$ $=0.0172$}\\
      \item \exstring{$P(\text{wheel or orange})$ $=0.439$}\\
      \item \exstring{$P(\text{flower})$ $=0.202$}\\
      \item \exstring{$P(\text{orange})$ $=0.362$}\\
      \item \exstring{$P(\text{gray given gem})$ $=0.18$} 
  \end{enumerate}
  \item \exstring{$P(\text{"gem" given "pink"}) = 0.0891 $}
  \item \exstring{$P(70.39 < X < 70.68) = 0.8111 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=97) = 0.0554$ }\\
      \item \exstring{ $P(78\le X \le 96) = 0.5916$} 
  \end{enumerate}
  \item \exstring{(12,\,13.1)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.51$}\\
      \item \exstring{$SE = 5.215$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.21$}\\
      \item \exstring{$0.02 < p\text{-value} < 0.04$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.663 or $66.3\%$}\\
      \item \exstring{UB of p CI = 0.701 or $70.1\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.025$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.49$}\\
      \item \exstring{$p\text{-value} = 0.0128$}\\

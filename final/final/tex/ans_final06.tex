...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{cat and yellow})$ $=0.0158$}\\
      \item \exstring{$P(\text{pig or red})$ $=0.446$}\\
      \item \exstring{$P(\text{red})$ $=0.294$}\\
      \item \exstring{$P(\text{cat given violet})$ $=0.37$}\\
      \item \exstring{$P(\text{tree})$ $=0.216$}\\
      \item \exstring{$P(\text{red given tree})$ $=0.371$} 
  \end{enumerate}
  \item \exstring{$P(\text{"kite" given "red"}) = 0.321 $}
  \item \exstring{$P(59.41 < X < 60.7) = 0.8914 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=36) = 0.0829$ }\\
      \item \exstring{ $P(28\le X \le 41) = 0.8644$} 
  \end{enumerate}
  \item \exstring{(14.1,\,15.8)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2$}\\
      \item \exstring{$SE = 0.093$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.15$}\\
      \item \exstring{$0.02 < p\text{-value} < 0.04$}\\
      \item \exstring{reject} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.749 or $74.9\%$}\\
      \item \exstring{UB of p CI = 0.775 or $77.5\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.091$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.16$}\\
      \item \exstring{$p\text{-value} = 0.0308$}\\
      \item \exstring{reject} 
  \end{enumerate}
\end{enumerate}

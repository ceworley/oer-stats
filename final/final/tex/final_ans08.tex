...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{pig given blue})$ $=0.228$}\\
      \item \exstring{$P(\text{teal})$ $=0.269$}\\
      \item \exstring{$P(\text{pig or gray})$ $=0.407$}\\
      \item \exstring{$P(\text{horn})$ $=0.185$}\\
      \item \exstring{$P(\text{red given wheel})$ $=0.212$}\\
      \item \exstring{$P(\text{flower and red})$ $=0.0663$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not pig" given "yellow"}) = 0.316 $}
  \item \exstring{$P(69.67 < X < 70.23) = 0.785 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=37) = 0.0742$ }\\
      \item \exstring{ $P(35\le X \le 48) = 0.5848$} 
  \end{enumerate}
  \item \exstring{(19,\,22.1)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 1.99$}\\
      \item \exstring{$SE = 3.921$}\\
  ...
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.934 or $93.4\%$}\\
      \item \exstring{UB of p CI = 0.938 or $93.8\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.024$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.03$}\\
      \item \exstring{$p\text{-value} = 0.0424$}\\

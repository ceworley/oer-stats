...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{cat})$ $=0.341$}\\
      \item \exstring{$P(\text{bike given white})$ $=0.154$}\\
      \item \exstring{$P(\text{pink})$ $=0.285$}\\
      \item \exstring{$P(\text{cat and red})$ $=0.0825$}\\
      \item \exstring{$P(\text{bike or red})$ $=0.353$}\\
      \item \exstring{$P(\text{pink given cat})$ $=0.135$} 
  \end{enumerate}
  \item \exstring{$P(\text{"kite" given "blue"}) = 0.2 $}
  \item \exstring{$P(73.88 < X < 74.3) = 0.8589 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=206) = 0.0689$ }\\
      \item \exstring{ $P(200\le X \le 210) = 0.672$} 
  \end{enumerate}
  \item \exstring{(29.5,\,37.3)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.14$}\\
      \item \exstring{$SE = 80.545$}\\
  ...
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.961 or $96.1\%$}\\
      \item \exstring{UB of p CI = 0.965 or $96.5\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}

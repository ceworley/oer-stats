...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{bike given indigo})$ $=0.326$}\\
      \item \exstring{$P(\text{flower and white})$ $=0.0464$}\\
      \item \exstring{$P(\text{indigo given bike})$ $=0.247$}\\
      \item \exstring{$P(\text{yellow})$ $=0.159$}\\
      \item \exstring{$P(\text{flower})$ $=0.416$}\\
      \item \exstring{$P(\text{flower or yellow})$ $=0.514$} 
  \end{enumerate}
  \item \exstring{$P(\text{"pig" given "not blue"}) = 0.324 $}
  \item \exstring{$P(64.77 < X < 65.17) = 0.7298 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=91) = 0.051$ }\\
      \item \exstring{ $P(81\le X \le 96) = 0.7745$} 
  \end{enumerate}
  \item \exstring{(10.1,\,11)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.41$}\\
      \item \exstring{$SE = 17.347$}\\
  ...
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.553 or $55.3\%$}\\
      \item \exstring{UB of p CI = 0.571 or $57.1\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}

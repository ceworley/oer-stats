...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{pink given horn})$ $=0.278$}\\
      \item \exstring{$P(\text{flower or red})$ $=0.604$}\\
      \item \exstring{$P(\text{horn and indigo})$ $=0.0836$}\\
      \item \exstring{$P(\text{horn})$ $=0.355$}\\
      \item \exstring{$P(\text{pig given red})$ $=0.179$}\\
      \item \exstring{$P(\text{indigo})$ $=0.145$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not tree" given "violet"}) = 0.236 $}
  \item \exstring{$P(60.01 < X < 60.35) = 0.6127 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=44) = 0.0548$ }\\
      \item \exstring{ $P(41\le X \le 57) = 0.8228$} 
  \end{enumerate}
  \item \exstring{(8.77,\,10)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 1.67$}\\
      \item \exstring{$SE = 52.513$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 1.87$}\\
      \item \exstring{$0.05 < p\text{-value} < 0.1$}\\
      \item \exstring{reject} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.908 or $90.8\%$}\\
      \item \exstring{UB of p CI = 0.914 or $91.4\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.064$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.08$}\\
      \item \exstring{$p\text{-value} = 0.0376$}\\
      \item \exstring{reject} 
  \end{enumerate}
\end{enumerate}

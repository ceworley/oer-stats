...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{pink})$ $=0.232$}\\
      \item \exstring{$P(\text{flower or black})$ $=0.514$}\\
      \item \exstring{$P(\text{bike})$ $=0.26$}\\
      \item \exstring{$P(\text{gem given pink})$ $=0.0491$}\\
      \item \exstring{$P(\text{wheel and red})$ $=0.0248$}\\
      \item \exstring{$P(\text{pink given gem})$ $=0.147$} 
  \end{enumerate}
  \item \exstring{$P(\text{"wheel" given "orange"}) = 0.243 $}
  \item \exstring{$P(61.92 < X < 62.35) = 0.7054 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=17) = 0.0905$ }\\
      \item \exstring{ $P(13\le X \le 25) = 0.8846$} 
  \end{enumerate}
  \item \exstring{(14.4,\,17.1)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.51$}\\
      \item \exstring{$SE = 6.522$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.45$}\\
  ...
  \item 
   \begin{enumerate}
      ...
      \item \exstring{UB of p CI = 0.33 or $33\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}

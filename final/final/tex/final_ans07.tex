...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{white})$ $=0.0828$}\\
      \item \exstring{$P(\text{gem given blue})$ $=0.18$}\\
      \item \exstring{$P(\text{yellow given horn})$ $=0.269$}\\
      \item \exstring{$P(\text{gem or yellow})$ $=0.505$}\\
      \item \exstring{$P(\text{gem and blue})$ $=0.0366$}\\
      \item \exstring{$P(\text{flower})$ $=0.389$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not horn" given "blue"}) = 0.691 $}
  \item \exstring{$P(65.96 < X < 66.74) = 0.7792 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=51) = 0.1022$ }\\
      \item \exstring{ $P(49\le X \le 59) = 0.749$} 
  \end{enumerate}
  \item \exstring{(42.1,\,49.1)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 3.05$}\\
      \item \exstring{$SE = 0.389$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.88$}\\
      \item \exstring{$0.01 < p\text{-value} < 0.02$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.0893 or $8.93\%$}\\
      \item \exstring{UB of p CI = 0.101 or $10.1\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0$}\\
      \item \exstring{$\mid z_\text{obs} \mid=NaN$}\\
      \item \exstring{$p\text{-value} = NaN$}\\

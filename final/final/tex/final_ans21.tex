...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{yellow given cat})$ $=0.439$}\\
      \item \exstring{$P(\text{wheel})$ $=0.281$}\\
      \item \exstring{$P(\text{cat given blue})$ $=0.408$}\\
      \item \exstring{$P(\text{wheel or yellow})$ $=0.603$}\\
      \item \exstring{$P(\text{cat and teal})$ $=0.209$}\\
      \item \exstring{$P(\text{teal})$ $=0.495$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not tree" given "green"}) = 0.802 $}
  \item \exstring{$P(63.31 < X < 63.96) = 0.878 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=17) = 0.1012$ }\\
      \item \exstring{ $P(9\le X \le 16) = 0.6524$} 
  \end{enumerate}
  \item \exstring{(52.1,\,59.2)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.01$}\\
      \item \exstring{$SE = 0.023$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 1.93$}\\
  ...
  \item 
   \begin{enumerate}
      ...
      \item \exstring{UB of p CI = 0.86 or $86\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$\mid z_\text{obs} \mid=2$}\\
      \item \exstring{$p\text{-value} = 0.0456$}\\

...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{horn and yellow})$ $=0.0524$}\\
      \item \exstring{$P(\text{dog})$ $=0.19$}\\
      \item \exstring{$P(\text{flower given black})$ $=0.198$}\\
      \item \exstring{$P(\text{yellow})$ $=0.331$}\\
      \item \exstring{$P(\text{teal given gem})$ $=0.384$}\\
      \item \exstring{$P(\text{flower or yellow})$ $=0.425$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not ring" given "not teal"}) = 0.474 $}
  \item \exstring{$P(68.3 < X < 69.42) = 0.8663 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=88) = 0.0627$ }\\
      \item \exstring{ $P(87\le X \le 103) = 0.6487$} 
  \end{enumerate}
  \item \exstring{(23.7,\,25.4)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 1.71$}\\
      \item \exstring{$SE = 17.9$}\\
  ...
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.56 or $56\%$}\\
      \item \exstring{UB of p CI = 0.648 or $64.8\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$\mid z_\text{obs} \mid=1.38$}\\
      \item \exstring{$p\text{-value} = 0.1676$}\\
      \item \exstring{reject} 
  \end{enumerate}
\end{enumerate}

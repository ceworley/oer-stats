...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{bike})$ $=0.296$}\\
      \item \exstring{$P(\text{gem given yellow})$ $=0.118$}\\
      \item \exstring{$P(\text{cat and black})$ $=0.0807$}\\
      \item \exstring{$P(\text{yellow})$ $=0.342$}\\
      \item \exstring{$P(\text{yellow given bike})$ $=0.399$}\\
      \item \exstring{$P(\text{dog or orange})$ $=0.46$} 
  \end{enumerate}
  \item \exstring{$P(\text{"dog" given "gray"}) = 0.113 $}
  \item \exstring{$P(62.43 < X < 63.23) = 0.7348 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=140) = 0.0529$ }\\
      \item \exstring{ $P(138\le X \le 153) = 0.7618$} 
  \end{enumerate}
  \item \exstring{(18,\,21.4)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.1$}\\
      \item \exstring{$SE = 0.54$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.17$}\\
      \item \exstring{$0.02 < p\text{-value} < 0.04$}\\
      \item \exstring{reject} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.481 or $48.1\%$}\\
      \item \exstring{UB of p CI = 0.489 or $48.9\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}

...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{cat and yellow})$ $=0.0633$}\\
      \item \exstring{$P(\text{flower})$ $=0.396$}\\
      \item \exstring{$P(\text{tree or yellow})$ $=0.359$}\\
      \item \exstring{$P(\text{yellow given cat})$ $=0.177$}\\
      \item \exstring{$P(\text{flower given yellow})$ $=0.273$}\\
      \item \exstring{$P(\text{violet})$ $=0.324$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not tree" given "white"}) = 0.787 $}
  \item \exstring{$P(63.62 < X < 64.06) = 0.8622 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=19) = 0.1167$ }\\
      \item \exstring{ $P(13\le X \le 23) = 0.9463$} 
  \end{enumerate}
  \item \exstring{(22.4,\,24.8)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 1.69$}\\
      \item \exstring{$SE = 2.082$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 1.44$}\\
      \item \exstring{$0.1 < p\text{-value} < 0.2$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.267 or $26.7\%$}\\
      \item \exstring{UB of p CI = 0.275 or $27.5\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.027$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.05$}\\
      \item \exstring{$p\text{-value} = 0.0404$}\\

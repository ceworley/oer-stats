...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{teal})$ $=0.205$}\\
      \item \exstring{$P(\text{horn given red})$ $=0.241$}\\
      \item \exstring{$P(\text{bike or black})$ $=0.363$}\\
      \item \exstring{$P(\text{teal given wheel})$ $=0.165$}\\
      \item \exstring{$P(\text{bike})$ $=0.24$}\\
      \item \exstring{$P(\text{bike and teal})$ $=0.0685$} 
  \end{enumerate}
  \item \exstring{$P(\text{"gem" given "black"}) = 0.265 $}
  \item \exstring{$P(72.47 < X < 72.81) = 0.7557 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=20) = 0.1113$ }\\
      \item \exstring{ $P(24\le X \le 29) = 0.2023$} 
  \end{enumerate}
  \item \exstring{(9.35,\,10.4)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.11$}\\
      \item \exstring{$SE = 0.009$}\\
  ...
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.522 or $52.2\%$}\\
      \item \exstring{UB of p CI = 0.548 or $54.8\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$\mid z_\text{obs} \mid=1.76$}\\
      \item \exstring{$p\text{-value} = 0.0784$}\\
      \item \exstring{reject} 
  \end{enumerate}
\end{enumerate}

...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{horn and orange})$ $=0.0911$}\\
      \item \exstring{$P(\text{wheel or white})$ $=0.411$}\\
      \item \exstring{$P(\text{white})$ $=0.251$}\\
      \item \exstring{$P(\text{bike given orange})$ $=0.21$}\\
      \item \exstring{$P(\text{dog})$ $=0.224$}\\
      \item \exstring{$P(\text{pink given dog})$ $=0.345$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not gem" given "red"}) = 0.231 $}
  \item \exstring{$P(64.96 < X < 65.89) = 0.7141 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=24) = 0.0728$ }\\
      \item \exstring{ $P(18\le X \le 35) = 0.9375$} 
  \end{enumerate}
  \item \exstring{(33.8,\,41.1)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.41$}\\
      \item \exstring{$SE = 0.16$}\\
  ...
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.625 or $62.5\%$}\\
      \item \exstring{UB of p CI = 0.633 or $63.3\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}

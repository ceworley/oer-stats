...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{flower})$ $=0.434$}\\
      \item \exstring{$P(\text{wheel or yellow})$ $=0.596$}\\
      \item \exstring{$P(\text{red})$ $=0.281$}\\
      \item \exstring{$P(\text{pig given white})$ $=0.0855$}\\
      \item \exstring{$P(\text{white given flower})$ $=0.0901$}\\
      \item \exstring{$P(\text{flower and white})$ $=0.0391$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not shovel" given "not white"}) = 0.533 $}
  \item \exstring{$P(65.28 < X < 65.85) = 0.839 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=14) = 0.1225$ }\\
      \item \exstring{ $P(8\le X \le 21) = 0.9508$} 
  \end{enumerate}
  \item \exstring{(24.5,\,26.5)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.02$}\\
      \item \exstring{$SE = 0.01$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.3$}\\
      \item \exstring{$0.02 < p\text{-value} < 0.04$}\\
      \item \exstring{reject} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.852 or $85.2\%$}\\
      \item \exstring{UB of p CI = 0.874 or $87.4\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.043$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.5$}\\
      \item \exstring{$p\text{-value} = 0.0124$}\\
      \item \exstring{reject} 
  \end{enumerate}
\end{enumerate}

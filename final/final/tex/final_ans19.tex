...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{cat or white})$ $=0.456$}\\
      \item \exstring{$P(\text{white})$ $=0.418$}\\
      \item \exstring{$P(\text{tree given white})$ $=0.168$}\\
      \item \exstring{$P(\text{red given dog})$ $=0.216$}\\
      \item \exstring{$P(\text{dog and white})$ $=0.105$}\\
      \item \exstring{$P(\text{bike})$ $=0.272$} 
  \end{enumerate}
  \item \exstring{$P(\text{"ring" given "violet"}) = 0.706 $}
  \item \exstring{$P(67.06 < X < 67.88) = 0.8396 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=37) = 0.0718$ }\\
      \item \exstring{ $P(37\le X \le 50) = 0.4721$} 
  \end{enumerate}
  \item \exstring{(11.2,\,12.8)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 1.67$}\\
      \item \exstring{$SE = 0.526$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 1.79$}\\
      \item \exstring{$0.05 < p\text{-value} < 0.1$}\\
      \item \exstring{reject} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.0795 or $7.95\%$}\\
      \item \exstring{UB of p CI = 0.0927 or $9.27\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}

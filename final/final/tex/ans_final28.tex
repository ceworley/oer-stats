...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{flower})$ $=0.326$}\\
      \item \exstring{$P(\text{yellow given bike})$ $=0.145$}\\
      \item \exstring{$P(\text{flower or green})$ $=0.515$}\\
      \item \exstring{$P(\text{cat and green})$ $=0.0728$}\\
      \item \exstring{$P(\text{blue})$ $=0.22$}\\
      \item \exstring{$P(\text{flower given black})$ $=0.538$} 
  \end{enumerate}
  \item \exstring{$P(\text{"cat" given "not yellow"}) = 0.334 $}
  \item \exstring{$P(62.45 < X < 63.21) = 0.7865 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=35) = 0.0524$ }\\
      \item \exstring{ $P(31\le X \le 52) = 0.9548$} 
  \end{enumerate}
  \item \exstring{(9.08,\,11)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.72$}\\
      \item \exstring{$SE = 7.788$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 2.44$}\\
      \item \exstring{$0.01 < p\text{-value} < 0.02$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.725 or $72.5\%$}\\
      \item \exstring{UB of p CI = 0.733 or $73.3\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.155$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.69$}\\
      \item \exstring{$p\text{-value} = 0.0072$}\\
      \item \exstring{retain} 
  \end{enumerate}
\end{enumerate}

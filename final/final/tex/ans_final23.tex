...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{pink given bike})$ $=0.388$}\\
      \item \exstring{$P(\text{pig given yellow})$ $=0.247$}\\
      \item \exstring{$P(\text{pig and pink})$ $=0.0703$}\\
      \item \exstring{$P(\text{wheel})$ $=0.179$}\\
      \item \exstring{$P(\text{bike or red})$ $=0.526$}\\
      \item \exstring{$P(\text{pink})$ $=0.291$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not wheel" given "not pink"}) = 0.647 $}
  \item \exstring{$P(71.02 < X < 71.32) = 0.893 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=12) = 0.1113$ }\\
      \item \exstring{ $P(7\le X \le 14) = 0.786$} 
  \end{enumerate}
  \item \exstring{(32.2,\,39.9)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.03$}\\
      \item \exstring{$SE = 6.807$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 1.91$}\\
      \item \exstring{$0.05 < p\text{-value} < 0.1$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.238 or $23.8\%$}\\
      \item \exstring{UB of p CI = 0.242 or $24.2\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      ...
      \item \exstring{$SE=0.088$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.7$}\\
      \item \exstring{$p\text{-value} = 0.007$}\\

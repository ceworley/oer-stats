...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{wheel and teal})$ $=0.123$}\\
      \item \exstring{$P(\text{violet given pig})$ $=0.366$}\\
      \item \exstring{$P(\text{pig given black})$ $=0.149$}\\
      \item \exstring{$P(\text{wheel})$ $=0.371$}\\
      \item \exstring{$P(\text{black})$ $=0.179$}\\
      \item \exstring{$P(\text{wheel or teal})$ $=0.576$} 
  \end{enumerate}
  \item \exstring{$P(\text{"not ring" given "green"}) = 0.83 $}
  \item \exstring{$P(65.97 < X < 66.22) = 0.7038 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=33) = 0.1018$ }\\
      \item \exstring{ $P(29\le X \le 40) = 0.8364$} 
  \end{enumerate}
  \item \exstring{(15.2,\,18.8)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 2.68$}\\
      \item \exstring{$SE = 22.027$}\\
  ...
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.294 or $29.4\%$}\\
      \item \exstring{UB of p CI = 0.3 or $30\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}

...
\begin{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$P(\text{orange given dog})$ $=0.335$}\\
      \item \exstring{$P(\text{horn and gray})$ $=0.0253$}\\
      \item \exstring{$P(\text{horn given gray})$ $=0.128$}\\
      \item \exstring{$P(\text{dog})$ $=0.322$}\\
      \item \exstring{$P(\text{gray})$ $=0.197$}\\
      \item \exstring{$P(\text{horn or red})$ $=0.402$} 
  \end{enumerate}
  \item \exstring{$P(\text{"cat" given "orange"}) = 0.432 $}
  \item \exstring{$P(70.05 < X < 70.54) = 0.6763 $}
  \item 
   \begin{enumerate}
      \item \exstring{$P(X=28) = 0.0814$ }\\
      \item \exstring{ $P(33\le X \le 40) = 0.1555$} 
  \end{enumerate}
  \item \exstring{(9.3,\,9.94)}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0:~~\mu_2-\mu_1 = 0$}\\
      \item \exstring{$H_0:~~\mu_2-\mu_1 \ne 0$}\\
      \item \exstring{$t^\star = 1.68$}\\
      \item \exstring{$SE = 0.021$}\\
      \item \exstring{$\mid t_\text{obs}\mid = 1.46$}\\
      \item \exstring{$0.1 < p\text{-value} < 0.2$}\\
      \item \exstring{retain} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{LB of p CI = 0.412 or $41.2\%$}\\
      \item \exstring{UB of p CI = 0.506 or $50.6\%$} 
  \end{enumerate}
  \item 
   \begin{enumerate}
      \item \exstring{$H_0: ~~p_2-p_1=0$}\\
      \item \exstring{$H_\text{A}:~~ p_2-p_1\ne 0$}\\
      \item \exstring{$z^\star = 2.81$}\\
      \item \exstring{$SE=0.118$}\\
      \item \exstring{$\mid z_\text{obs} \mid=2.68$}\\
      \item \exstring{$p\text{-value} = 0.0074$}\\
      \item \exstring{retain} 
  \end{enumerate}
\end{enumerate}

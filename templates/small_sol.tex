...
%% packages
\usepackage{a4wide,color,verbatim,Sweave,url,xargs,amsmath,hyperref,booktabs,longtable}
...
%% headings
\markboth{\textnormal{\bf \large Key ID: \myID}}%
{\textnormal{\bf \large Key ID: \myID}}
...
\begin{enumerate}
\renewenvironment{question}{\item \textbf{Problem}\newline}{}
\renewenvironment{solution}{\comment}{\endcomment}
\renewenvironment{answerlist}{\renewcommand{\labelenumi}{(\alph{enumi})}\begin{enumerate}}{\end{enumerate}}
%% \exinput{exercises}
\end{enumerate}
...
\renewenvironment{solution}{\item \textbf{Solution}\newline}{}
\renewenvironment{answerlist}{\renewcommand{\labelenumi}{(\alph{enumi})}\begin{enumerate}}{\end{enumerate}}
%% \exinput{exercises}
\end{enumerate}
